An expense and budget tracking app that allows users to monitor their spending, create expense categories, view spending summaries by category, and track their budget by calculating remaining 
